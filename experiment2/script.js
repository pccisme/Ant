...
document.getElementById("page2prevBtn").addEventListener("click", function(){
    if(document.getElementById("slide2").className == "active"){
        console.log("hi")
        document.getElementById("page2prevBtn").classList.add("hidden");
        document.getElementById("page2nextBtn").classList.remove("hidden");
    }else{
...
document.getElementById("page2nextBtn").addEventListener("click", function(){
    if(document.getElementById("slide5").className == "active"){
        document.getElementById("page2nextBtn").classList.add("hidden");
        document.getElementById("page2prevBtn").classList.remove("hidden");
    }else{
        document.getElementById("page2nextBtn").classList.remove("hidden");
        document.getElementById("page2prevBtn").classList.remove("hidden");
...
function renderGraphic(){
    ...
    context.drawImage(imgObj,0,0,330,220)
    var width = 5;
    var height = 5;
